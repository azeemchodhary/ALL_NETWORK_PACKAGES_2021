...
public class Zong extends Fragment {
    ...
    void initialization(View item)
    {
        ...
        {
            title = getResources().getStringArray(R.array.zongdatahybrid_name);
            description = getResources().getStringArray(R.array.zongdatahybrid_description);
            code = getResources().getStringArray(R.array.zongdatahybrid_code);
        }
        if(tab.equals("Data"))
        {
            title = getResources().getStringArray(R.array.zongdatadata_name);
            description = getResources().getStringArray(R.array.zongdatadata_description);
            code = getResources().getStringArray(R.array.zongdatadata_code);
        }
        if(tab.equals("Calls"))
        {
            title = getResources().getStringArray(R.array.zongdatacall_name);
            description = getResources().getStringArray(R.array.zongdatacall_description);
            code = getResources().getStringArray(R.array.zongdatacall_code);
        }
        if(tab.equals("Sms"))
        {
            title = getResources().getStringArray(R.array.zongdatasms_name);
            description = getResources().getStringArray(R.array.zongdatasms_description);
            code = getResources().getStringArray(R.array.zongdatasms_code);
        }
