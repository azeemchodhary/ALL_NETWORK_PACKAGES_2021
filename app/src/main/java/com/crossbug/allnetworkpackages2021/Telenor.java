...
public class Telenor extends Fragment {
     ...
     void initialization(View item)
    {
        ...
        {
            title = getResources().getStringArray(R.array.telenordatahybrid_name);
            description = getResources().getStringArray(R.array.telenordatahybrid_description);
            code = getResources().getStringArray(R.array.telenordatahybrid_code);
        }
        if(tab.equals("Data"))
        {
            title = getResources().getStringArray(R.array.telenordatadata_name);
            description = getResources().getStringArray(R.array.telenordatadata_description);
            code = getResources().getStringArray(R.array.telenordatadata_code);
        }
        if(tab.equals("Calls"))
        {
            title = getResources().getStringArray(R.array.telenordatacall_name);
            description = getResources().getStringArray(R.array.telenordatacall_description);
            code = getResources().getStringArray(R.array.telenordatacall_code);
        }
        if(tab.equals("Sms"))
        {
            title = getResources().getStringArray(R.array.telenordatasms_name);
            description = getResources().getStringArray(R.array.telenordatasms_description);
            code = getResources().getStringArray(R.array.telenordatasms_code);
        }
