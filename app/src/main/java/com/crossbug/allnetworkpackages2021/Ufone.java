...
public class Ufone extends Fragment {
    ...
    void initialization(View item)
    {
        ...
        {
            title = getResources().getStringArray(R.array.ufonedatahybrid_name);
            description = getResources().getStringArray(R.array.ufonedatahybrid_description);
            code = getResources().getStringArray(R.array.ufonedatahybrid_code);
        }
        if(tab.equals("Data"))
        {
            title = getResources().getStringArray(R.array.ufonedatadata_name);
            description = getResources().getStringArray(R.array.ufonedatadata_description);
            code = getResources().getStringArray(R.array.ufonedatadata_code);
        }
        if(tab.equals("Calls"))
        {
            title = getResources().getStringArray(R.array.ufonedatacall_name);
            description = getResources().getStringArray(R.array.ufonedatacall_description);
            code = getResources().getStringArray(R.array.ufonedatacall_code);
        }
        if(tab.equals("Sms"))
        {
            title = getResources().getStringArray(R.array.ufonedatasms_name);
            description = getResources().getStringArray(R.array.ufonedatasms_description);
            code = getResources().getStringArray(R.array.ufonedatasms_code);
        }
